const projectCards = [
  {
    ...
    description: 'This is an app in wich you can reserve a Yatch, delete a yatch booking and show all your reserved yatchs. This app is a webpage in where you can see the details of every yatch and the city of depart, in there you can reserve all the yatchs you want, and also cancel it, after that you can check out all the bookings made, with the yatch, date and city. This page was made using the most advanced program languages such as Ruby on Rails, React, Redux and a custom API to ensure the best experience. ',
  ...
  },
  {
    ...
    description: 'This is a webpage in wich you can see Pokémons from a list, see de type, attacks, and also you can use a searchbar to find the Pokémon of your liking.This project utilize one of the best programming languages, using React with the help of Redux to store the information, all connected to an external API that comes with the Pokémon library.',
    tags: ['React', 'API'],
  ...
  },
  {
    ...
    description: 'This is a concert webpage where you can see the information about the new music event, this event works with popular singers as Sia and Maroon 5. It was developed with the help of some of the best technologies sucha as HTML, CSS, and JavaScript, using principally DOM to manipulate the information. Do not hesitate to come and see the project.',
