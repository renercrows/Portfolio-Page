const projectCards = [
  {
    ...
    description: 'A rental webpage where you can book different yachts, set up the desired city, see reservations, and delete it. This project was made using React, Redux, Rails, and API. It is a five people project, so do not hesitate to visit Daniel Gonzales`s repository and check out the project webpage.',
  ...
  },
  {
    ...
    description: 'This webpage was made using mainly React, Redux and Webpack. This project connects to a Pokédex API using a Pokémon gallery, so see your favorites Pokémon of the first generation using the searcher bar at the top-middle of the page, and also check the stats and attacks of the selected Pokémon. Feel free to come and check it out.',
    tags: ['React', 'API'],
  ...
  },
  {
    ...
    description: 'This is a concert page made to see the new concert event that works with different singers. It was developed with HTML, CSS, and JavaScript, using DOM as the main JavaScript code. Do not hesitate to come and see the project.',
  ...
  },
  {
    ...
    title: 'Book-Store',
    img: 'images/Book.png',
    description: 'This webpage was built using mainly React and Redux, with also the use of Webpack. This project displays the book store, and also allows you to set the title and author of every book you store.  Feel free to come and check out the project.',
