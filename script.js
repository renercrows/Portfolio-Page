const projectCards = [
  {
    ...
    description: 'A rental webpage where you can do booking of diferent yatchs, setup the city where you want it, see reservations and deleted. This project was made using React, Redux, Rails and API. It is a five people project, so do not hesitate to visit Daniel Gonzales repository and check out the project.',
  ...
  },
  {
    ...
    description: 'This page was made using mainly React and Redux. This project connects to a Pokedex API using a Pokemon gallery, see your favorites Pokemon of the first generation using the searcher bar at the top-middle of the page, and also can check the stats and attacks of the selected Pokemon. Feel free to come and check it out.',
    tags: ['React', 'API'],
  ...
  },
  {
    ...
    description: 'A webpage of a concert with different singers, this is a concert page to check out the new concert event. It was developed with HTML, CSS and JavaScript, using DOM as the main JavaScript code. Do not hesitate to come and see the project.',
  ...
  },
  {
    ...
    title: 'Book-Store',
    img: 'images/Book.png',
    description: 'About This webpage was built using mainly React and Redux. This project displays the Book store, setting the user title of the book and author and categorizing it. You can post your inputs through the API. Feel free to check it out.',
